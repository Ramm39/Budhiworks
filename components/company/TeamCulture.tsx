...
const culturePoints = [
  {
    title: "Craftsmanship & Learning",
    description: "We're a small, focused team of experienced engineers and designers who care about building good software. We value craftsmanship, continuous learning, and honest work.",
    icon: "🎨",
  },
  {
    title: "Trust & Autonomy",
    description: "Our culture is built on trust, autonomy, and accountability. Everyone on the team has the freedom to make decisions and the responsibility to see them through.",
    icon: "🤝",
  },
  {
    title: "Quality over Scale",
    description: "We're not interested in growth for growth's sake. We'd rather work with fewer clients and do excellent work than scale up and compromise on quality.",
    icon: "⭐",
  },
];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-[#4F7DF3] text-xs tracking-widest font-medium">TEAM & CULTURE</span>
            <span className="w-2 h-2 rounded-full bg-[#4F7DF3]" />
          </motion.div>
