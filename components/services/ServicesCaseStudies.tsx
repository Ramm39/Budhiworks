...
const caseStudies = [
  {
    ...
    problem: "Legacy system couldn't handle growing traffic",
    solution: "Built scalable microservices architecture with 99.9% uptime",
  },
  {
    title: "Internal Operations Dashboard",
    problem: "Manual processes slowing down team productivity",
    solution: "Automated workflows reduced processing time by 70%",
  },
  {
    title: "Startup MVP Launch",
    problem: "Need to validate product idea quickly",
    solution: "Delivered working MVP in 6 weeks, secured first customers",
  },
];

export function ServicesCaseStudies() {
  return (
    <section className="py-28 md:py-36 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-white dark:bg-dark-base">
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(to right, transparent, rgba(34, 211, 238, 0.1), rgba(79, 125, 243, 0.08), transparent)",
          filter: "blur(52px)",
        }}
        animate={{
          x: ["200%", "-100%"],
