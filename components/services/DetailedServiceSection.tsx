      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-white leading-tight tracking-tight">
              {title}
            </h2>
            <p className="text-sm md:text-base text-gray-200 dark:text-gray-300 mb-8 leading-relaxed">
              {description}
            </p>
            <ul className="space-y-4">
              {features.map((feature, idx) => (
                <motion.li
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true, amount: 0.12 }}
                  transition={{ duration: 0.3, delay: idx * 0.06, ease: easeSmooth }}
              ...
              {image ? (
                ...
                <div className="absolute inset-0 bg-white/5 flex items-center justify-center">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.35, delay: 0.2, ease: easeSmooth }}
