...
const features = [
  {
    ...
    description: "Every solution starts with understanding your business needs and goals.",
    color: "accent-blue",
  },
  {
    title: "Clear communication, no guesswork",
    description: "Transparent processes and regular updates keep you informed every step of the way.",
    color: "accent-cyan",
  },
  {
    title: "Built to scale, not just launch",
    description: "We design systems that grow with your business, not against it.",
    color: "accent-blue",
  },
  {
    title: "Support beyond delivery",
    description: "Ongoing maintenance and support ensure your systems stay reliable.",
    color: "accent-cyan",
  },
];
