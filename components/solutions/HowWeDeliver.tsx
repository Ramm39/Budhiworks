...
const steps = [
  {
    ...
    description: "Understand your business, technical constraints, and success criteria.",
    icon: "🔍",
  },
  {
    number: "02",
    title: "Architecture & Planning",
    description: "Design system architecture, define technical approach, and create delivery roadmap.",
    icon: "📐",
  },
  {
    number: "03",
    title: "Build & Iterate",
    description: "Develop with regular check-ins, testing, and incremental delivery.",
    icon: "🔨",
  },
  {
    number: "04",
    title: "Launch, Support & Improve",
    description: "Deploy, monitor, and continuously improve based on real usage and feedback.",
    icon: "🚀",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            {steps.map((step, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.12 }}
                transition={{ duration: 0.35, delay: index * 0.08, ease: easeSmooth }}
                whileHover={{ y: -4 }}
              ...
              >
                <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-[#22D3EE]/30 hover:bg-white/[0.07] transition-all duration-500 ease-out overflow-hidden h-full">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-4 group-hover:text-[#22D3EE] transition-colors duration-500 text-center">
                    {step.title}
                  </h3>
                  <p className="text-sm md:text-base text-gray-200 leading-relaxed text-center">
                    {step.description}
                  </p>
                </div>
              </motion.div>
